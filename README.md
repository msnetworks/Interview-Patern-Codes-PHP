...
The Minimum Edit Distance program calculates the minimum number of operations required to convert one string into another. The program is implemented in PHP using a dynamic programming approach.
...
This program uses a 2D matrix to compute the minimum number of edits needed.

Features

Calculates the minimum edits between two strings.

Outputs the result in a readable format.

Code Description

The program defines the following function:

editRequired($str1, $str2)

This function computes the minimum number of operations needed to convert $str1 into $str2.
...
Minimum edits required to convert 'geek' to 'gesek' is: 1
Minimum edits required to convert 'cat' to 'cut' is: 1

How to Run

Save the code to a file named edit_distance.php.

Run the script in a terminal using PHP:
